...
DESCRIPTION="OryxCoin - a hybrid PoW+PoS energy efficient p2p-cryptocurrency and electronic payment system."
...
src_install() {
	...
	newins "src/qt/res/icons/OryxCoin-128.png" "${PN}.png"

	make_desktop_entry "${PN}-qt" "OryxCoin" "/usr/share/pixmaps/${PN}.png" "Network;P2P;Finance;"

	if use kde; then
		insinto /usr/share/kde4/services
		newins contrib/debian/OryxCoin-qt.protocol ${PN}.protocol
	fi
}
